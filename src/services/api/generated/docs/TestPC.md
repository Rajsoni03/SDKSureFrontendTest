...
**hostname** | **string** | Hostname of the PC | [default to undefined]
**ip_address** | **string** | IP address of the PC | [default to undefined]
...
**last_heartbeat_at** | **string** | Last heartbeat received from this PC | [readonly] [default to undefined]
**is_online** | **string** |  | [readonly] [default to undefined]
**is_available_for_testing** | **string** |  | [readonly] [default to undefined]
